...
if __name__ == '__main__':
    ...
    input("Move to your first desired position and push enter ...")
    end_joint_command = limb.get_joint_angles()

    input("Move to your second desired position and push enter ...")
    ...
    for i in range(number_of_trials):
        ...
        sio.savemat('/home/radlab/Desktop/part3_trial'+str(i).zfill(2) + '.mat', data)
